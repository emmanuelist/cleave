...
export const MOVES: Record<string, Move[]> = {
  "01-landing": [
    { at: 2.0, sel: "h1" },
    { at: 8.0, sel: ".cell.edge dd", label: "the edge, live", zoom: 1.7 },
    { at: 13.5, sel: ".live-foot", zoom: 1 },
  ],
  "02-instrument": [
    ...
    { at: 12.0, sel: "#segUp" },
    { at: 15.5, sel: "#gap", label: "the gap is the edge", zoom: 1.8 },
    { at: 20.0, sel: "#edge" },
    { at: 25.0, sel: ".v-track", label: "expanded twentyfold", zoom: 1.5 },
    { at: 31.0, sel: "#pEquity", zoom: 1 },
    { at: 35.5, sel: "#pPaired", label: "sets at par", zoom: 1.6 },
    { at: 40.0, sel: "#pNaked", label: "only this carries risk" },
    { at: 45.0, sel: "#countdown", zoom: 1 },
    { at: 49.0, sel: "#lineage li:first-child" },
    { at: 54.0, sel: ".trace-wrap", label: "capped, not chased", zoom: 1.4 },
    { at: 61.0, sel: "body", zoom: 1 },
  ],
  "03-activity": [
    { at: 2.0, sel: "#posState", label: "naked leg" },
    { at: 7.5, sel: '#events li[data-k="leg"]', label: "completing", zoom: 1.7 },
    { at: 14.0, sel: '#events li[data-k="fill"], #events li[data-k="leg"]', label: "or refusing" },
    { at: 19.0, sel: "body", zoom: 1 },
  ],
  "04-settlement": [],
};
